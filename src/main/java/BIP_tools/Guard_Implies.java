...
public class Guard_Implies extends Guard{
	...
	public Guard_Implies(String name, String guardMethod, Component parent,  State srcState, State dstState, Component srcComponent,
